...
export const events = {
    ImplementationSet: event("0x7acba6e3c47815c1b41b230650f7ed720d66bdc6ca45468c4a6cdb9425132024", {"_implementation": indexed(p.address), "_codeHash": p.bytes32, "_code": p.bytes}),
    ...
    ProxyCreated: event("0xcfaab0d6675a72a93c114f48dd85add1076be0c88545968759ef034da7ad146f", {"_address": indexed(p.address), "_salt": p.bytes32}),
}

export const functions = {
    code: fun("0x24c12bf6", {}, p.bytes),
    codeHash: fun("0x18edaaf2", {}, p.bytes32),
    collections: fun("0xfdbda0ec", {"_0": p.uint256}, p.address),
    collectionsSize: fun("0xdfaf33e9", {}, p.uint256),
    createCollection: fun("0x9d2d3957", {"_salt": p.bytes32, "_data": p.bytes}, p.address),
    getAddress: fun("0xaf222399", {"_salt": p.bytes32, "_address": p.address, "_data": p.bytes}, p.address),
    implementation: fun("0x5c60da1b", {}, p.address),
    isCollectionFromFactory: fun("0xc0300011", {"_0": p.address}, p.bool),
