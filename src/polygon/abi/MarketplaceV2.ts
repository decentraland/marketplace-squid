...
export const events = {
    ChangedFeesCollectorCutPerMillion: event("0xd33ed052f0041ea5512df480eb51801acb8fec4a7e89c6086fdd5caaa650981e", {"feesCollectorCutPerMillion": p.uint256}),
    ChangedPublicationFee: event("0xe7fa8737293f41b5dfa0d5c3e552860a06275bed7015581b083c7be7003308ba", {"publicationFee": p.uint256}),
    ChangedRoyaltiesCutPerMillion: event("0xba54fecf3e91476de2d7bd3248ee80a9060cddc82a6ac0933b232e051eafdaf3", {"royaltiesCutPerMillion": p.uint256}),
    FeesCollectorSet: event("0x58283f7e46512bbcb30558fa508283f23fac7be18fb20bfdf6d4bbf83c529d53", {"oldFeesCollector": indexed(p.address), "newFeesCollector": indexed(p.address)}),
    ...
    RoyaltiesManagerSet: event("0x7af757e60ce7c97cfab72d633ae4d05ffe9be9afbba020aa2f484a600db8df6d", {"oldRoyaltiesManager": indexed(p.address), "newRoyaltiesManager": indexed(p.address)}),
...
export const functions = {
    ...
    cancelOrder: fun("0x6a206137", {"nftAddress": p.address, "assetId": p.uint256}, ),
    createOrder: fun("0x6f652e1a", {"nftAddress": p.address, "assetId": p.uint256, "priceInWei": p.uint256, "expiresAt": p.uint256}, ),
    ...
    executeOrder: fun("0xae7b0333", {"nftAddress": p.address, "assetId": p.uint256, "price": p.uint256}, ),
