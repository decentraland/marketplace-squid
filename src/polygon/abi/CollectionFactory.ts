...
export const events = {
    ImplementationChanged: event("0x39b832a8f081478030a2180aeddc64e58329325ac2e8d863a9ca2594a80c4103", {"_implementation": indexed(p.address), "_codeHash": p.bytes32, "_code": p.bytes}),
...
export const functions = {
    ...
    createProxy: fun("0xd277dc89", {"_salt": p.bytes32, "_data": p.bytes}, p.address),
    getAddress: fun("0x20d06ff9", {"_salt": p.bytes32, "_address": p.address}, p.address),
    implementation: fun("0x5c60da1b", {}, p.address),
    owner: fun("0x8da5cb5b", {}, p.address),
    renounceOwnership: fun("0x715018a6", {}, ),
    setImplementation: fun("0xd784d426", {"_implementation": p.address}, ),
