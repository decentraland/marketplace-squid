module.exports = class Data1719231754794 {
    name = 'Data1719231754794'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "sale" ("id" character varying NOT NULL, "type" character varying(5) NOT NULL, "buyer" text NOT NULL, "seller" text NOT NULL, "price" numeric NOT NULL, "timestamp" numeric NOT NULL, "tx_hash" text NOT NULL, "search_token_id" numeric NOT NULL, "search_contract_address" bytea NOT NULL, "search_category" text NOT NULL, "nft_id" character varying, CONSTRAINT "PK_d03891c457cbcd22974732b5de2" PRIMARY KEY ("id"))`)
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "marketplace_squid_1719231559"."IDX_3caf2d6b31d2fe45a2b85b8191"`)
        await db.query(`DROP TABLE "data"`)
        await db.query(`DROP INDEX "marketplace_squid_1719231559"."IDX_8694618f20c7b364d4cb23c111"`)
        await db.query(`DROP INDEX "marketplace_squid_1719231559"."IDX_ae7e5532f8406258419ed617b4"`)
        await db.query(`DROP TABLE "estate"`)
        await db.query(`DROP INDEX "marketplace_squid_1719231559"."IDX_0b680d37990796da3232ad9d98"`)
        await db.query(`DROP INDEX "marketplace_squid_1719231559"."IDX_c40a1b5f5b764ad6ab5fa749cd"`)
        await db.query(`DROP TABLE "parcel"`)
        await db.query(`DROP INDEX "marketplace_squid_1719231559"."IDX_a7c5c87cd4ffc1e1129f0c5f43"`)
        await db.query(`DROP INDEX "marketplace_squid_1719231559"."IDX_da4912d77606dcfabe5da7eebc"`)
        await db.query(`DROP INDEX "marketplace_squid_1719231559"."IDX_04ab2b996d659d2f86dbcee860"`)
        await db.query(`DROP TABLE "wearable"`)
        await db.query(`DROP INDEX "marketplace_squid_1719231559"."IDX_f011ccea27833b0628a7532834"`)
        await db.query(`DROP TABLE "ens"`)
        await db.query(`DROP INDEX "marketplace_squid_1719231559"."IDX_2ebf256442a48f5acbdf2ea77d"`)
        await db.query(`DROP TABLE "nft"`)
        await db.query(`DROP INDEX "marketplace_squid_1719231559"."IDX_83cfd3a290ed70c660f8c9dfe2"`)
        await db.query(`DROP INDEX "marketplace_squid_1719231559"."IDX_b92ac830e4b3a630162a898203"`)
        await db.query(`DROP INDEX "marketplace_squid_1719231559"."IDX_31459100f31150048a6d5fda2a"`)
        await db.query(`DROP INDEX "marketplace_squid_1719231559"."IDX_c93c3ba3d64f3ac7dca84ef45b"`)
        await db.query(`DROP INDEX "marketplace_squid_1719231559"."IDX_2d559d06edaadb3c3facd8159c"`)
        await db.query(`DROP INDEX "marketplace_squid_1719231559"."IDX_070ce4690a766ec56a00acc7e0"`)
        await db.query(`DROP TABLE "order"`)
        await db.query(`DROP INDEX "marketplace_squid_1719231559"."IDX_f5047ff046d513a3598c1a2931"`)
        await db.query(`DROP TABLE "transfer"`)
        await db.query(`DROP INDEX "marketplace_squid_1719231559"."IDX_024eb30e5fd99a5bea7befe60e"`)
        await db.query(`DROP INDEX "marketplace_squid_1719231559"."IDX_c116ab40c3b32ca2d9c1d17d8b"`)
        await db.query(`DROP INDEX "marketplace_squid_1719231559"."IDX_be54ea276e0f665ffc38630fc0"`)
        await db.query(`DROP INDEX "marketplace_squid_1719231559"."IDX_4cbc37e8c3b47ded161f44c24f"`)
        await db.query(`DROP INDEX "marketplace_squid_1719231559"."IDX_f605a03972b4f28db27a0ee70d"`)
        await db.query(`DROP TABLE "sale"`)
        await db.query(`DROP INDEX "marketplace_squid_1719231559"."IDX_8524438f82167bcb795bcb8663"`)
